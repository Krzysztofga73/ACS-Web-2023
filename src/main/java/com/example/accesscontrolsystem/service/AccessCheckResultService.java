...
public class AccessCheckResultService {
    ...
    public void addRecord(AccessCheckResultModel acr) {
...
//    }
//
//    public void addRecord(RecordAbstractModel acr) {
//        accessCheckResultRepository.save(acr);
//    }
//
//    public List<RecordAbstractModel> getResults() {
//        return accessCheckResultRepository.findAll();
//    }
//
//    public RecordAbstractModel getResultById(Long id) {
//        return accessCheckResultRepository.findById(id).orElse(null);
//    }
//
//    public void saveEditResult(RecordAbstractModel acr) {
//        accessCheckResultRepository.save(acr);
//    }
//
//    public void removeResult(Long id) {
...
//        response.setHeader(headerKey, headerValue);
//
//        List<RecordAbstractModel> list = getResults();
//
...
//    }
//
//    public void sortResults(List<RecordAbstractModel> res, String sortBy) {
//        if (sortBy != null) {
//            switch (sortBy) {
//                case "id":
//                    res.sort(Comparator.comparing(RecordAbstractModel::getId));
//                    break;
//                case "creationDate":
//                    res.sort(Comparator.comparing(u -> u.getCreationDate().toString()));
//                    break;
...
//
//        Date dateToCompare = new Date(System.currentTimeMillis() - 10 * 60 * 1000);   // wartość czasu ustawiania na stałe
//        List<RecordAbstractModel> acrFiltered = getResults().stream()              // lista z odfiltrowanymi rekordami
//                .filter(e -> e.getCreationDate().before(dateToCompare))
//                .collect(Collectors.toList());
//
//        if (!acrFiltered.isEmpty()) {
...
//
//
//    public String getACRCount(List<RecordAbstractModel> acr) {
//        return "Total number of records: " + acr.size();
//    }
//
//
//    private void saveToCSV(List<RecordAbstractModel> list, String filePath) throws IOException {
//        Boolean isBackup = false;
//        Boolean isEmpty = false;
//
//        try {
...
//                    csvPrinter.printRecord("Id", "Description", "CreationDate");
//                }
//                for (RecordAbstractModel e : list) {
//                    csvPrinter.printRecord(e.getId(), e.getDescription(), e.getCreationDate());
//                }
//                csvPrinter.flush();
//            } catch (IOException e) {
